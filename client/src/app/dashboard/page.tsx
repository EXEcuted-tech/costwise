    ...
    >
      ...
      >
        <div className="w-[70%]">
          ...
          <div
            ...
            } bg-white rounded-b-[10px] drop-shadow-lg px-[40px] py-[20px]`}
          >
            <div className="flex items-center">
              ...
              <h2 className="text-[#C6C6C6] font-light text-[20px]">
                Last Update: <span className="italic">2:15 AM</span>
              </h2>
            </div>
              ...
              <div className="w-[20%] flex flex-col items-center">
                ...
                <div>
                  <div className="flex items-center mr-[-20px] justify-end">
                    ...
                    <p className="text-[10px] 2xl:text-[12px] 3xl:text-[16px] text-[#CD3939] font-semibold">
                      -40%
                    </p>
                  </div>
      ...
      >
        <div className={`${isAdmin ? "w-full 3xl:w-[70%]" : "w-full"}`}>
          ...
          <div
            className={`flex flex-grow bg-white h-[600px] min-h-[600px] rounded-b-[10px] drop-shadow-lg items-center justify-center ${
              isOpen ? "px-[20px] 3xl:px-[20px]" : "px-[5px] 2xl:px-[20px]"
            }`}
          >

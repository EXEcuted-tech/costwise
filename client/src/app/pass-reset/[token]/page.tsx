    ...
    <>
      ...
      <div className='flex flex-col animate-pop-out bg-white w-[550px] h-auto pb-[30px] rounded-[20px] px-[10px] gap-3'>
        <div className='flex justify-center'>
          <div className='absolute left-[30px] top-[30px] group'>
              ...
              <div className="absolute w-[300px] h-auto bg-[#FFD3D3] text-[1em] text-[#B22222] p-4 left-[35px] top-[20px] rounded-lg drop-shadow-lg invisible opacity-0 transition-all duration-300 ease-in-out group-hover:visible group-hover:opacity-100 4xl:text-[1em] 3xl:text-[1em] 2xl:text-[0.8em] xl:text-[0.8em]">
              <p className='text-[18px] font-bold'>Password must contain:</p>
                <div className='text-[16px] pl-[20px]'>
                  <p>- at least 8 characters.</p>
                  <p>- uppercase and lowercase letters.</p>
                  <p>- special letters &#40;e.g. *&#91;&#93;@#$%*^&+=&#41;</p>
                </div>
              </div>
          </div>

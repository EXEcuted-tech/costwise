...
const ProjectedCostPage = () => {
  ...
  const [priceData, setPriceData] = useState([
    {
      ...
      products: [
        { productName: "VIRGINIA Cocktail Hotdog 250g", cost: 32.770408 },
        { productName: "VIRGINIA Sweet Ham 250g", cost: 67.023943 },
        { productName: "VIRGINIA Chicken Hotdog 250g", cost: 19.170082 },
        { productName: "VIRGINIA Chorizo de Cebu 250g", cost: 44.70468 },
      ],
    },
  ]);
  ...
  useEffect(() => {
    const fetchPredictions = async () => {
      ...
      console.log("Testing ", (await response).data.data);
    };
  ...
  useEffect(() => {
    const fetchFile = async () => {
      try {
        ...
        console.log("Response Settings:", response.data.data[0].settings);

        const fetchedData = JSON.parse(response.data.data[0].settings);

        console.log("Formatted Price Data: ", fetchedData);
  ...
  useEffect(() => {
    if (priceData.length > 0) {
      const months = priceData.map((entry) => entry.monthYear);
      const getCostsForProduct = (productName) => {
      ...
      const datasets = [
        {
          ...
          data: getCostsForProduct(selectedProduct),
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-center h-[50%] w-[100%] bg-white p-2">
              <h2>Product Cost Trend</h2>
              <select onChange={handleProductChange} value={selectedProduct}>
                <option value="VIRGINIA Cocktail Hotdog 250g">
                  VIRGINIA Cocktail Hotdog 250g
                </option>
                <option value="VIRGINIA Sweet Ham 250g">
                  VIRGINIA Sweet Ham 250g
                </option>
                <option value="VIRGINIA Chicken Hotdog 250g">
                  VIRGINIA Chicken Hotdog 250g
                </option>
                <option value="VIRGINIA Chorizo de Cebu 250g">

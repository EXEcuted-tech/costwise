...
const GettingStartedPage = () => {
    ...
    return (
        <div className='bg-cover bg-center items-center justify-center bg-[#FFFAF8] h-[100vh] overflow-hidden '>
            <div>
            ...
            <div className='flex h-[90%] w-[98%] pl-[90px] pt-[15px]'>
                <div className='flex flex-col bg-white w-full rounded-xl p-10 drop-shadow-lg -z-[0] mr-[30px]'>
                    <div className='flex flex-row w-full items-center justify-start border-b border-[#ACACAC] gap-[15px]'>
                        ...
                        <p className='flex items-center justify-start text-primary text-[40px] font-bold'>Getting Started</p>

...
const GettingStartedPage = () => {
    ...
    return (
        <div className='bg-cover bg-center items-center justify-center bg-[#FFFAF8] w-[93.5vw] h-[100vh] overflow-hidden '>
            <div>
                <Header icon={PiBookOpenText} title="User's Management"></Header>
            </div>
            <div className='flex h-[90%] w-[98%] pl-[90px]  pt-[45px]'>
                <div className='flex flex-col bg-white w-full rounded-xl p-10 drop-shadow-lg -z-[0]'>

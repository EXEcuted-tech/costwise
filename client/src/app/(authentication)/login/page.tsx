...
function LoginPage() {
  return (
    <div className="flex items-center justify-center h-full z-1">
      {/* Left Div */}
      <div className="w-[40%] flex-row h-full p-[5%] text-primary py-[10%] sm:px-[4%] sm:p-[10%]">
        ...
        <div className="bg-white h-[15%] items-center flex w-[100%] justify-center sm:text-[1.1em] lg:text-[1.8em] font-medium border-y-2 border-primary">
          <p className="flex-col justify-center">Welcome to CostWise</p>
        </div>
        <div className=" h-[10%] items-center flex-row justify-center w-[100%] sm:text-[0.8em] lg:text-[1.1em] font-light">
        ...
        <div className="bg-white h-[45%] items-center flex-row w-[100%] justify-center sm:text-[0.8em] text-[1.2em]">
          <div className="flex items-end justify-center h-[80%] sm:h-[60%]">
          ...
          <div className="flex items-center justify-center h-[15%] sm:pb-[10%]">
      ...
      <div className="w-[60%] flex-row h-full bg-primary p-[5%] py-[10%] text-white rounded-e-3xl drop-shadow-3xl">
        <div className=" h-[20%] items-end flex justify-center w-[100%]">
          <p className="text-[2.5em] font-semibold sm:text-[1.6em]">
            Login To Your Account
          </p>
        </div>
        <div className=" h-[10%] items-end flex justify-start w-[100%] pb-[1%]">
          <FaRegEnvelope className="mx-[1%] text-[1.7em] sm:text-[0.8em]" />
        ...
        <div className=" h-[10%] items-end flex justify-start w-[100%] pb-[1%]">
          <MdLockOutline className="mx-[1%] mb-[0.5%] text-[1.7em] sm:text-[0.8em]" />

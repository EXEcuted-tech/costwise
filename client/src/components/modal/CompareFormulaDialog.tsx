...
const CompareFormulaDialog: React.FC<{ setCompareFormula: React.Dispatch<React.SetStateAction<boolean>> }> = ({ setCompareFormula }) => {
    ...
    return (
        <div className={`flex items-center justify-center w-full h-full top-0 left-0 fixed backdrop-brightness-50 z-[1000]`}>
            <div className='px-[35px] mx-[50px] 2xl:mx-0 animate-pop-out bg-white w-[860px] min-h-[213px] mt-[-50px] rounded-[10px]'>
                ...
                <div className='mt-[10px]'>
                    ...
                    <div className='flex justify-end pt-[20px] pb-[25px]'>
                        <div className="relative inline-flex bg-white overflow-hidden text-primary flex items-center justify-center rounded-[30px] cursor-pointer transition-all rounded group">
                            <button className="text-[22px] font-bold before:ease relative px-[30px] py-[2px] h-full w-full overflow-hidden bg-primary text-white shadow-2xl transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:shadow-primary hover:before:-translate-x-52">

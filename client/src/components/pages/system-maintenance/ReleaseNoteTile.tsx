...
const ReleaseNoteTile:React.FC<SystemMaintenanceProps> = ({date, title, author}) => {
    return (
        <div className='flex w-full h-[4rem] mb-5 items-center bg-[#F5F5F5] drop-shadow-lg rounded-lg group hover:bg-[#e3e3e3] transition-colors duration-300 ease-in-out'>
            ...
            <span className='ml-8 mr-5 text-[25px] text-[#5B5353]'>{title}</span>
            <span className='mr-3 text-[21px] text-[#5B5353] font-light'>by: </span>
            <span className='text-[21px] text-[#5B5353] font-light'>{author}</span>

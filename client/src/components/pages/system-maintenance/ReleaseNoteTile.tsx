    ...
    return (
        <div className='flex w-full h-[65px] mb-5 items-center bg-[#F5F5F5] drop-shadow-lg rounded-lg group hover:bg-[#e3e3e3] transition-colors duration-300 ease-in-out leading-tight'>
            ...
            <div className='flex flex-row w-[80%]'>
                <span className='ml-8 mr-3 text-[22px] 2xl:text-[25px] text-[#5B5353] text-ellipsis'>
                    {note.title}</span>
                <span className={`${isOpen ? 'hidden 4xl:block' : 'hidden 2xl:block'} mt-1  text-[18px] 2xl:text-[21px] text-[#5B5353] font-light`}>

...
const CreateReleaseNotes: React.FC<CreateReleaseNotesProps> = ({setCreateNotes}) => {
    ...
    return (
        <div className='flex justify-center items-center z-[1000] w-full h-full fixed p-4 overflow-auto top-0 left-0 bg-[rgba(0,0,0,0.5)]'>
            ...
            <div className="flex flex-col w-[50%] h-[750px] bg-white dark:bg-[#3C3C3C] rounded-[20px] animate-pop-out drop-shadow">

                {/* Header */}
                <div className='flex items-center rounded-t-[10px] h-[10%] bg-[#F5F5F5] dark:bg-[#121212] text-[27px] font-bold'>
                ...
                <div className="h-full ">
                    {/* Title Area */}
                    <div className='flex-row mt-4 mb-4 dark:text-white '>

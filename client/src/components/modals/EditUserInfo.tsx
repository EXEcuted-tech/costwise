...
const EditUserInfo: React.FC<EditUserInfoProps> = ({ onClose }) => {
    return (
        <div className='flex justify-center items-center z-[1000] w-full h-full fixed top-0 left-0 bg-[rgba(0,0,0,0.5)]'>
            <div className="flex flex-col w-[55rem] h-[41rem] mx-[50px] p-6 bg-white shadow-md shadow-gray-800 rounded-lg animate-pop-out max-4xl:scale-90 max-3xl:scale-85 max-2xl:scale-80 max-xl:scale-75 max-xl:left-[15%] max-2xl:left-[20%] max-3xl:left-[25%]"> 

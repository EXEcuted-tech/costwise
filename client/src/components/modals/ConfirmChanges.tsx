    ...
    <div className='flex items-center justify-center w-full h-full top-0 left-0 fixed backdrop-brightness-50 z-[1000]'>
      <div className='animate-pop-out bg-white dark:bg-[#3C3C3C] w-[460px] h-[380px] rounded-[20px] px-[10px]'>
        ...
        <div className='flex flex-col justify-center items-center pb-[20px]'>
          ...
          <p className='text-center text-[#9D9D9D] dark:text-[#d1d1d1] text-[19px] px-[30px]'>
            The inputted information will be discarded. Do you want to proceed?
          </p>
        </div>
        <div className='my-[2px] px-[50px] grid grid-cols-2 gap-4'>
          ...
          <div className="relative bg-white dark:bg-[#3C3C3C] border-1 border-primary overflow-hidden text-primary flex items-center justify-center rounded-[30px] cursor-pointer transition-all rounded group"
            onClick={() => { setConfirmChanges(false) }}>
